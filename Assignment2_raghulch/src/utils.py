...
# ---- global config expected by analysis.py ----
...
def load_png_dir(
    ...
    """
    Load grayscale, resized PNGs to flat vectors. Skips only truly broken/tiny files.
    Env: MIN_BYTES (default 0) to enforce minimum file size.
    """
    X, y = [], []
...
def save_confusion(
    ...
    """Name EXACTLY as analysis.py expects."""
    import matplotlib
    matplotlib.use("Agg")
...
# back-compat alias some earlier code might use
